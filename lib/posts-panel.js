(function() {
  ...
  module.exports = PostsPanel = (function(superClass) {
    ...
    PostsPanel.prototype.initialize = function(postManager) {
      ...
      this.postManagerSubscriptions.add(this.postManager.on('post-load-fail post-publish-fail post-saving-fail', (function(_this) {
        return function(arg) {
          var error, post;
    ...
    PostsPanel.prototype.loadPosts = function() {
      ...
      Promise.all([publicPostPromise, draftPostPromise, draftPublicPostPromise]).then((function(_this) {
        return function() {
          ...
          if (totalPosts < 1) {
            _this.totalPosts.hide();
            _this.searchSection.hide();
            _this.emptySection.removeClass('hidden');
          } else {
            _this.totalPosts.show();
            _this.searchSection.show();
