(function() {
  ...
  module.exports = PublishForm = (function(superClass) {
    ...
    function PublishForm(postManager) {
    ...
    PublishForm.prototype.handleButtonEvents = function() {
      ...
      this.draftButton.on('click', (function(_this) {
        return function() {
          ...
          _this.postManager.getClient().draft({
            ...
            _this.div({
              ...
              _this.label({
                ...
                return _this.select({
                    ...
                    return function() {
                      var options = [
                        {value:'2', description: 'Development'},
                        {value:'3', description: 'Design'},
                        {value:'4', description: 'QA'},
                        {value:'5', description: 'Others'},
                        {value:'1', description: 'Help'}
                      ];
    ...
    PublishForm.prototype.show = function() {
          ...
          buttons: [
            {
              ...
              onDidClick: function() {
                ...
                shell.openExternal(this.postManager.getCLient().getServerHost());
                return notification.dismiss();
              }
            }
          ]
      ...
      var htmlContents = markdownIt.render(this.contents);
      var o;
      if (cheerio == null) {
      ...
      // var descriptionBlock = o('div').contents().filter(function(i, el){
      //   return el.type == 'comment';
      // }).slice(0,1);
      // var descriptionData = {};
      // if (descriptionBlock) {
      //   descriptionData = descriptionBlock[0].data;
      // }
      // descriptionData.trim().split("\n").forEach(function(elm) { console.log(elm); return elm.split(":"); });

      if (title && this.titleInput.model.getText() == '') {
        this.titleInput.model.setText(title);
      }
