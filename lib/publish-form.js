(function() {
  ...
  module.exports = PublishForm = (function(superClass) {
    ...
    PublishForm.prototype.setData = function(post) {
      ...
      if (this.post && this.post.tags instanceof Array) {
        this.tagsInput.getModel().setText(post.tags.join(', '));
      } else {
        ...
        return function() {
          ...
          _this.postManager.draft({
            ...
            return function(result) {
              ...
              _that.titleInput.model.setText('');
              _that.hide();
              _this.emitPostEvent('post-save-as-draft' + (isDraftPublic ? '-public' : '') + '-failed', _this.post);
              if (result.success) {
    ...
    PublishForm.prototype.show = function() {
      ...
      var htmlContents = markdownIt.render(this.post.contents);
