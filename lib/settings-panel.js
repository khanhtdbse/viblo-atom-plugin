(function() {
  ...
  module.exports = SettingsPanel = (function(superClass) {
    ...
    var saveApiToken = function(token) {
      ...
      fs.isDirectory(vibloDir, (function(_this) {
        return function(result) {
          if (result) {
            ...
            writeStream = fs.createWriteStream(tokenPath);
      ...
      this.disposables.add(this.apiToken.getModel().onDidStopChanging(
        (function(_this){
            return _.debounce(function() {
              ...
              _this.updateMessage.html(new TokenUpdateView({message:'Token updated'}));
              saveApiToken(token);
