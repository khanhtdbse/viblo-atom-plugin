...
(function() {
  ...
  module.exports = PostManager = (function() {
    ...
    PostManager.prototype.getPublished = function(callback) {
      return this.getClient().request('GET', '/posts/published?perPage=100', function(data) {
        callback(data);
      })
    }

    PostManager.prototype.getDrafts = function(callback) {
      return this.getClient().request('GET', '/posts/drafts?perPage=100', function(data) {
        callback(data);
      })
    }

    PostManager.prototype.getDraftPublished = function(callback) {
      return this.getClient().request('GET', '/posts/publicDrafts?perPage=100', function(data) {
        callback(data);
      })
    }
