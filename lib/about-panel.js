          ...
          _this.div({
            ...
            _this.div({
              ...
              _this.h1({
                ...
                _this.p({}, function() {
                  _this.span({'class': 'icon viblo-logo'});
                });
                _this.text('Viblo');
              });
            });
            _this.div({
              ...
              _this.h2({}, function() {
                _this.span({'class':'icon viblo-quote-left'},'');
                _this.text('Free service for technical knowledge sharing ');
                _this.span({'class':'icon viblo-quote-right'},'');
              });
            });
            _this.div({
              'class' : 'about-footer'
                ...
                _this.div({
                  ...
                  _this.h3({}, function() {
                    _this.span({'class':'icon viblo-facebook-official'},'');
                    _this.a({
                      'href' : 'https://www.facebook.com/codewar.framgia/'
                    }, function() {
                      _this.text('Facebook Fanpage');
                    });
                  })
