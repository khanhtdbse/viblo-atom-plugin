...
const isValidClosing = (state, pos) => {
...
const findBlockLastLine = (start, end, state) => {
    let current = start
...
module.exports = (md, options) => {
    ...
    md.renderer.rules.math_inline = (tokens, idx) => render(tokens[idx].content, options1)
    md.renderer.rules.math_block = (tokens, idx) => render(tokens[idx].content, options2)
}
