...
(function() {
  ...
  VibloPluginPostsPanel = require('./viblo-plugin-posts-panel');
  ...
  module.exports = VibloPluginSettingsView = (function(superClass) {
        ...
        return function() {
          _this.div({
            ...
            return _this.div({
              ...
              return _this.button({
                "class": 'btn btn-default icon icon-gears',
                outlet: 'openSettings'
              }, 'Settings');
            });
          });
    ...
    VibloPluginSettingsView.prototype.initialize = function(arg) {
      ...
      ref1 = arg != null ? arg : {}, this.uri = ref1.uri, activePanel = ref1.activePanel;
    ...
    VibloPluginSettingsView.prototype.initializePanels = function() {
      ...
      this.openSettings.on('click', function() {
        return alert('Settings Panel Opened');
      });

      this.addCorePanel('Posts', 'pencil', function(_this) {
          return new VibloPluginPostsPanel();
      });
