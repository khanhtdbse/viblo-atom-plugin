(function() {
  ...
  module.exports = PostCard = (function(superClass) {
    ...
    PostCard.content = function(arg) {
      var title, url, category, createdAt, categorylist, categoryId;
      title = arg.title;
      url = arg.url;
      categoryId = arg.category_id;
      createdAt = moment(arg.created_at);
      category = _.filter(require('./post-category'), function(elm, i) {
        return parseInt(elm['value']) === categoryId;
      }).pop();
            ...
            if (category) {
              _this.p({}, function() {
                ...
                _this.span({
                  ...
                  return _this.text(category.description);
                });
              });
            }
          });
